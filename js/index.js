...
function getPostsFromBackend() {
    var settings = {
        "url": "https://throttle-club.herokuapp.com/get/posts?order="+paginationQuery.order,// http://localhost:3000/         http://localhost:3000/get/posts?order="+paginationQuery.order
        "method": "GET",
        "timeout": 0,
        "headers": {
